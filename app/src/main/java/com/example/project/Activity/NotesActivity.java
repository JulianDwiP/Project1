...
import com.example.project.utils.NoteUtils;
...
public class NotesActivity extends AppCompatActivity implements NoteEventListener, Drawer.OnDrawerItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Catatan Pribadi");
    ...
    private void onDeleteMultiNotes() {
        ...
        if (chackedNotes.size() != 0) {
            ...
            loadNotes();
            Toast.makeText(this, chackedNotes.size() + " Catatan Sukses Terhapus !", Toast.LENGTH_SHORT).show();
        } else Toast.makeText(this, "Tidak ada catatan yg terpilih", Toast.LENGTH_SHORT).show();
    }
